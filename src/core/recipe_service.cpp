...
void RecipeService::seedSystemRecipes() {
    ...
    struct { const char *n; const char *d; int t; const char *mt; const char *tags[5]; struct { const char *in; double a; } items[8]; } recipes[] = {
        // 家常菜
        {"番茄炒蛋","家常经典",10,"any",{"家常菜","快手菜","咸鲜","高蛋白"},{{"鸡蛋",200},{"西红柿",300},{"盐",3},{"食用油",15}}},
        {"蛋炒饭","快手主食",8,"any",{"家常菜","快手菜","主食","咸鲜"},{{"大米",200},{"鸡蛋",100},{"食用油",10},{"盐",2},{"大葱",10}}},
        {"青椒炒肉","下饭神器",10,"lunch",{"家常菜","快手菜","咸鲜","辣"},{{"猪瘦肉",200},{"青椒",150},{"食用油",10},{"酱油",10},{"蒜",5},{"盐",3}}},
        ...
        {"蒜蓉西兰花","健康素菜",8,"any",{"家常菜","快手菜","轻食","减脂"},{{"西兰花",300},{"蒜",15},{"食用油",10},{"盐",3}}},
        ...
        {"醋溜白菜","快手素菜",8,"any",{"家常菜","快手菜","酸","减脂"},{{"白菜",400},{"醋",20},{"食用油",10},{"盐",3},{"蒜",5}}},
        // 汤羹甜品
        {"西红柿蛋汤","快手汤品",10,"any",{"汤羹甜品","快手菜","轻食"},{{"西红柿",200},{"鸡蛋",100},{"盐",3},{"食用油",5},{"香菜",5}}},
        ...
        {"紫菜蛋花汤","极简汤品",5,"any",{"汤羹甜品","免开火","快手菜","轻食"},{{"鸡蛋",100},{"盐",2},{"香油",3}}},
        {"南瓜粥","暖胃早餐",30,"breakfast",{"汤羹甜品","轻食","甜"},{{"大米",100},{"南瓜",300},{"糖",10}}},
        // 主食
        {"番茄鸡蛋面","一餐搞定",15,"breakfast",{"主食","快手菜","咸鲜","高蛋白"},{{"面条",200},{"鸡蛋",100},{"西红柿",200},{"食用油",10},{"盐",3}}},
        {"蛋炒饭（升级）","粒粒分明",8,"any",{"主食","快手菜","家常菜","咸鲜"},{{"大米",250},{"鸡蛋",150},{"胡萝卜",50},{"青椒",50},{"食用油",15},{"盐",3},{"大葱",10}}},
        {"葱油拌面","上海经典",10,"any",{"主食","快手菜","咸鲜"},{{"面条",200},{"食用油",30},{"大葱",50},{"生抽",15},{"糖",5}}},
        {"馒头","基础主食",0,"any",{"主食","免开火"},{{"馒头",200}}},
        ...
        {"煎饺","焦香酥脆",15,"any",{"小吃","主食","咸鲜"},{{"面粉",200},{"猪瘦肉",250},{"白菜",150},{"食用油",15},{"酱油",10},{"盐",5},{"姜",5}}},
        // 凉菜沙拉
        {"凉拌黄瓜（升级）","清脆开胃",5,"any",{"凉菜沙拉","快手菜","免开火","酸","减脂"},{{"黄瓜",300},{"蒜",15},{"醋",20},{"生抽",10},{"糖",5},{"辣椒粉",3}}},
        {"凉拌木耳","营养小菜",5,"any",{"凉菜沙拉","快手菜","免开火","酸","减脂"},{{"木耳",100},{"醋",15},{"生抽",10},{"蒜",10},{"香油",5},{"香菜",10}}},
        {"皮蛋豆腐","经典凉菜",5,"any",{"凉菜沙拉","免开火","快手菜","高蛋白"},{{"豆腐",300},{"生抽",15},{"香油",5},{"蒜",5}}},
        // 烤箱/空气炸锅
        ...
        {"可乐鸡翅","孩子最爱",25,"lunch",{"宴客节日","甜","咸鲜","高蛋白"},{{"鸡翅",500},{"生抽",20},{"料酒",10},{"姜",10}}},
        ...
        {"燕麦牛奶","早餐营养",5,"breakfast",{"快手菜","免开火","增肌","高蛋白"},{{"牛奶",250},{"燕麦",50},{"糖",5}}},
        {"水煮蛋","最简单蛋白质",10,"breakfast",{"快手菜","高蛋白","增肌"},{{"鸡蛋",200}}},
